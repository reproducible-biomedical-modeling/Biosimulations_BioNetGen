...
class CliTestCase(unittest.TestCase):
    ...
    def test_build_docker_image(self):
        ...
        # build image
        image_repo = 'ghcr.io/biosimulators/biosimulators_bionetgen/bionetgen'
    ...
    def test_validator(self):
        ...
        valid_cases, case_exceptions, _ = validator.run('ghcr.io/biosimulators/biosimulators_bionetgen/bionetgen', 'biosimulators.json')
